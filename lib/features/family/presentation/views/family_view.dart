                      ...
                      ? SliverToBoxAdapter(
                          child: SizedBox(
                            ...
                            child: buildLoadingView(
                                LocaleKeys.family_family.tr().toLowerCase(),
                                context),
                          ),
                        )
                          ...
                          builder: (context, state) {
                            if (state is AddChildCubitInitial ||
                                  ...
                                  child: Center(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          LocaleKeys.family_noChildrenAddedYet
                                              .tr(),
                                ...
                                child: Center(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        LocaleKeys
                                            .family_failedToLoadingChildren
                                            .tr(),
                                        style: AppStyles.styleSemiBold20(),
                                      ),
                                      const SizedBox(height: 10),
                              ...
                              return SliverToBoxAdapter(
                                child: Center(
                                  child: Text(
                                    LocaleKeys.family_noChildrenAddedYet.tr(),
