...
class _LogInState extends State<LogIn> {
  ...
  void updateLoginState(bool isLoading) {
    setState(() {
      login = isLoading;
    });
  }
      ...
      child: Scaffold(
        body: ListView(
          children: [
            AbsorbPointer(
              absorbing:
                  login, // This will disable text fields when login is true
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.only(start: 30, end: 28),
                    child: Form(
                      key: formKey,
                      child: Column(
                  ...
                  CustomButtonLogIn(
                    callback: updateLoginState, // Pass the method reference
                    formState: formKey,
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Text(
                          ...
                          style:
                              AppStyles.styleRegular20().copyWith(fontSize: 16),
                        ),
                      ),
                    ],
                  ),
