...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> ar = {
    "PageView1": {
      ...
      "subtitle":
          "قم بمراقبة احتياجات طفلك بسهولة وإدارة جميع التفاصيل الخاصة به من مكان واحد، لتوفير تجربة سلسة ومتكاملة.",
      "button": "التالي"
    },
    "PageView2": {
      "title": "سهولة التحكم",
      "subtitle":
          "قم بتحديد الميزانية اليومية لطفلك وتتبع أنشطته لضمان إدارة سلسة وفعالة.",
      "button": "التالي"
    },
    "PageView3": {
    ...
    "allegries": {
      ...
      "allegries_headline":
          "يرجى تحديد جميع أنواع الحساسية التي تنطبق على طفلك. سيتم استخدام هذه المعلومات للمساعدة في الحفاظ على سلامة طفلك والتأكد من تجنبه لأي مسببات للحساسية.",
  ...
  static const Map<String, dynamic> en = {
    ...
    "allegries": {
      ...
      "allegries_headline":
          "Please select all the allergies that apply to your child. This information will be used to help keep your child safe and ensure they avoid any allergens.",
